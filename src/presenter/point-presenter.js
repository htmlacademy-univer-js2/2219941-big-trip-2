...
export default class PointPresenter {
  ...
  init = (point) => {
    ...
    this.#pointComponent.setRollDownButtonCallback(this.#handleRollDownButtonClick);
    this.#pointComponent.setFavoriteButtonCallback(this.#handleFavoriteButtonClick);
